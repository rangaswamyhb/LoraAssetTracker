...
eLoraModuleSelector_t 	eLoraModuleSelector = APP_CONFIG_LORA_MODULE_SELECTOR;//LORA_MODULE_PING_PONG;//LORA_MODULE_WAN_NETWORK;
uint32_t				loraMasterSelector  = APP_CONFIG_LORA_IS_MASTER;
