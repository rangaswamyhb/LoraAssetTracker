...
//    MibRequestConfirm_t my_mibReq;
//    DeviceClass_t currentClass;
//
//    my_mibReq.Type = MIB_DEVICE_CLASS;
//    LoRaMacMibGetRequestConfirm( &my_mibReq );
//    currentClass = my_mibReq.Param.Class;
//
//    if( currentClass != CLASS_A )
//    {
//    	my_mibReq.Param.Class = CLASS_A;
//		LoRaMacMibSetRequestConfirm( &my_mibReq );
//    }
