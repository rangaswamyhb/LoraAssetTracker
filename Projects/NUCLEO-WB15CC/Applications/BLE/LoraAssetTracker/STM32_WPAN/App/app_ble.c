...
uint8_t u8AdvData[30] = {0,};

uint8_t au8ServiceData[12] = {
	sizeof(au8ServiceData) - 1, AD_TYPE_SERVICE_DATA,
	0xAA,
	0xAA,
	0x55,
	0x55,
...
//    memcpy((uint8_t *)u8AdvData, (uint8_t *)manuf_data, sizeof(manuf_data));
//    memcpy((uint8_t *)&u8AdvData[sizeof(manuf_data)], (uint8_t *)au8ServiceData, sizeof(au8ServiceData));
