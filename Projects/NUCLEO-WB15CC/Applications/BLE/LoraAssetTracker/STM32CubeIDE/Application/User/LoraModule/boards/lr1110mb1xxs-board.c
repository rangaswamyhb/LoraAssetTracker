...
extern void lna_on( void );
extern void lna_off( void );

void lr1110_board_lna_on( void )
{
	lna_on( );
}

void lr1110_board_lna_off( void )
{
	lna_off( );
}
...
void lr1110_board_init( const void* context, lr1110_dio_irq_handler dio_irq )
{
    ...
    rf_switch_configuration.rx      = LR1110_SYSTEM_RFSW1_HIGH;
    rf_switch_configuration.tx      = LR1110_SYSTEM_RFSW1_HIGH | LR1110_SYSTEM_RFSW0_HIGH;
...
//    lr1110_system_config_lfclk(context, LR1110_SYSTEM_LFCLK_EXT, true);
