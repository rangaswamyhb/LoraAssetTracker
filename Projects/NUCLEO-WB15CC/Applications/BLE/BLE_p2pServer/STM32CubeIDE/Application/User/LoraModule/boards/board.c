...
#include "lr1110_adc.h"
#include "lr1110_spi.h"
...
//    LR1110.reset.pin      = RADIO_RESET;
//    LR1110.nss.pin        = RADIO_NSS;
//    LR1110.event.pin      = RADIO_EVENT;
//    LR1110.event.callback = radio_event_callback;
//    LR1110.event.context  = ( ( lr1110_t* ) context );
//    LR1110.busy.pin       = RADIO_BUSY;
//    LR1110.spi.pins.miso  = RADIO_MISO;
