 ...
 */
#define LORAMAC_VERSION                             0x01000000// 0x01010100
#endif
 ...
 * Module context.
 */
PLACE_IN_SECTION("MB_MEM2") ALIGN(4) static LoRaMacCtx_t MacCtx;

PLACE_IN_SECTION("MB_MEM2") ALIGN(4) static LoRaMacNvmData_t Nvm;

PLACE_IN_SECTION("MB_MEM2") ALIGN(4) static Band_t RegionBands[REGION_NVM_MAX_NB_BANDS];
